...
defined( 'WP1S_VERSION' ) or define( 'WP1S_VERSION', '1.1.2' ); //plugin version
...
/**
     ...
     */
        ...
        function wp1s_register_assets()
        {
            ...
            wp_enqueue_script('wp1s-frontend-script',WP1S_JS_DIR.'/wp1s-frontend-script.js',array('jquery'),WP1S_VERSION);
        ...
        function wp1s_form_footer_function() {
        include('inc/wp1s-form-footer.php');
        }
